...
// File Name: subscribe_process.php
//
// Purpose: Processing logic for subscribing process. 
//
///////////////////////////////////////////////////
...
<div align="center">
  ...
  <div align="left"><br>
    ...
    <table width="100%"  border="0">
      <tr>
        <td><b>
          <p>Error. Unable to make subscription.</b><br><br> Click <a href="main.php">here</a> to go back to the main menu.</p>
...
<html>
<head>
<title>Customer: Subscription Confirmation</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>
...
<div align="center">
  ...
  <div align="left"><br>
    ...
    <table width="100%"  border="0">
      <tr>
        <td><b>
          <p>Your subscription has been made.</b><br><br> Click <a href="main.php">here</a> to go back to the main menu.</p>
...
$sqlQuery = "INSERT INTO orderlist(product_id, customer_id, quantity, active) VALUES('$productId', '$customerId', '$productQuantity', 'yes')";
