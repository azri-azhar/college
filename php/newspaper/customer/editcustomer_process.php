...
// File Name: editcustomer_process.php
//
...
$sqlDb = mysql_select_db('azri') or die("Can't select database");
	...
	$sqlQueryPassword = "SELECT password FROM customer WHERE username = '$username'";
...
$sqlQuery = "UPDATE customer SET username = '$username', password = '$password', name = '$name', ic = '$ic', address = '$address', state = '$state', town = '$town', postcode = '$postcode', telephone = '$telephone', email = '$email' WHERE id = $customerId";
