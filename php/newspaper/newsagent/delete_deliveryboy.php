...
// File Name: delete_deliveryboy.php
//
// Purpose: Display page for deleting delivery boy.
//
///////////////////////////////////////////////////
...
<div align="center">
  ...
  <div align="left"><br>
    ...
    <table width="100%"  border="0">
      <tr>
        <td><b>
          <p>Error. Unable to delete.</b><br><br> Click <a href="main.php">here</a> to go back to the main menu.</p>
...
<html>
<head>
<title>Newsagent: Delete Confirmation</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>
...
<div align="center">
  ...
  <div align="left"><br>
    ...
    <table width="100%"  border="0">
      <tr>
        <td><b>
          <p>Your delivery boy has been deleted.</b><br><br> Click <a href="javascript: history.go(-1)">here</a> to go the previous page.</p>
...
<?php
		...
		{ 
			...
			$sqlQuery = "DELETE FROM deliveryboy WHERE id = '$deleteid'";
