...
$sqlQuery = "SELECT * FROM newsagent WHERE username = '$username' AND password = '$password' ";
...
if (!$worked)
{
	...
	{
			session_start();
			$_SESSION['newsagent_username'] = $worked['username'];
			$_SESSION['newsagent_id'] = $worked['id'];
