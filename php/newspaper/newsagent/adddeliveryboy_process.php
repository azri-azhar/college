...
// File Name: adddeliveryboy_process.php
//
// Purpose: Processing logic for adding delivery boy.
//
///////////////////////////////////////////////////
...
<html>
<head>
<title>Newsagent: Delivery Boy Confirmation</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>
...
<div align="center">
  ...
  <div align="left"><br>
    ...
    <table width="100%"  border="0">
      <tr>
        <td><b>
          <p>Your delivery boy has been added.</b><br><br> Click <a href="javascript: history.go(-1)">here</a> to go the previous page.</p>
...
else 
{
				...
				$deliveryboyUsername = $_POST['txtDeliveryUsername'];
				$deliveryPassword = md5( $_POST['txtDeliveryPassword'] );
				...
				$sqlQuery = "INSERT INTO deliveryboy(username, password, newsagent_id) VALUES('$deliveryboyUsername', '$deliveryPassword', '$newsagentId') ";
