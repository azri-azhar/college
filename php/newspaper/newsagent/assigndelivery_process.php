...
// File Name: assigndeliveryboy_process.php
//
// Purpose: Processing logic for assigning delivery
// boy
//
///////////////////////////////////////////////////
...
<html>
<head>
<title>Newsagent: Assign Confirmation</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>
...
<div align="center">
  ...
  <div align="left"><br>
    ...
    <table width="100%"  border="0">
      <tr>
        <td><b>
          <p>Your delivery boy has been assign.</b><br><br> Click <a href="javascript: history.go(-1)">here</a> to go the previous page.</p>
...
<div align="center">
  ...
  <div align="left"><br>
    ...
    <table width="100%"  border="0">
      <tr>
        <td><b>
          <p>Error. Unable to assign.</b><br><br> Click <a href="main.php">here</a> to go back to the main menu.</p>
...
{	
		...
		$countOrderlistId=count($orderlistId);
		$countDeliveryboyId=count($deliveryboyId);
		 ...
		 for ($i=0; $i<$countOrderlistId; $i++) {
		 	
			$sqlQuery = "UPDATE orderlist SET deliveryboy_id = $deliveryboyId[$i] WHERE id = $orderlistId[$i] " ;
