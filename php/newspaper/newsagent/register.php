...
//
// Purpose: Display registration form for newsagent.
//
///////////////////////////////////////////////////
...
<html>
<head>
<title>Newsagent: Register</title>
...
$body = <<< STARTBODY
	...
	<form name="formRegister" method="post" action="register_process.php" />
		...
		<table>
			...
			<tr>
				<td>Company Name</td>
				<td><input type="text" name="txtCompanyName" />
			<tr>
			
			
			<tr>
				<td>Registration Number</td>
				<td><input type="text" name="txtRegistrationNumber" />
			</td>
