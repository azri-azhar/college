...
// File Name: main.php
//
// Purpose: Display main menu for delivery boy and
// information and what publication needs to be
// send today.
//
///////////////////////////////////////////////////
...
<html>
<head>
<title>Delivery Boy: Main Menu</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>
...
<div align="center">
  ...
  <div align="left"><br>
    ...
    <img src="../images/div2.jpg" width="400" height="17"><br>
            <br>
    <p><b>Delivery Boy Main Menu</b></p>
    <p>These are the newspapers that you need to send today.</p>	
STARTHEADER;

$footer = <<< STARTFOOTER
  </div>
<br>
  <div align="left"><a href="../index.php">Back to Home</a><br><br></div>
  <p align="left"><img src="../images/div2.jpg" width="400" height="17"><br></p>
</div>
</body>
</html>
STARTFOOTER;
...
STARTJAVA;
					...
					echo '<form name="formAssign" method="post" action="main_process.php">';
					...
					echo "</tr>";
						...
						echo '<input type="submit" name="btnLogin" value="Confirm Delivery" onClick="return confirmSubmit()" />';
