...
<p>The inventory item has been updated. Go back to <a href="main.php">main menu</a></p>
          <p>&nbsp;</p></td></tr>
    </table></td>
  </tr>
</table>
...
PAGE;
			...
			$description = $_POST['txtDescription'];
				...
				$sqlQuery = "UPDATE lab SET	category = '$category',	name = '$name', serial = '$serial',	price = '$price', location = '$location', condition = '$condition',	description = '$description' WHERE id = $id";
