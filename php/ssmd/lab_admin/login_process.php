...
$sqlQuery = "SELECT * FROM authorization WHERE username = '$username' AND password = '$password' AND class = 1 ";
...
AUTO;
	...
	{
			session_start();
			$_SESSION['lab_username'] = $worked['username'];
			$_SESSION['lab_id'] = $worked['id'];
