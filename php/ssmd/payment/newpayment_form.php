    ...
    <td height="251" bgcolor="#DDE6EE"><table width="100%"  border="0" cellspacing="2" cellpadding="2">
      <tr>
        <td width="77%" height="354" valign="top" bgcolor="#FFFFFF"><table width="100%"  border="0" cellspacing="2" cellpadding="2">
          <tr>
              <td bgcolor="#EEEEDD"><strong>Add New Payment</strong></td>
          </tr>
          </table>          
          <p>
...
BOTTOM;
	...
	$display_page = <<< PAGE
		...
		<form name="formAddOrdering" method="post" action="newpayment_process.php" >
			<table>				
				<tr>
					<td>Ordered By: </td>
					<td>$byee
				...
				<tr>
					...
					<td><input type="text" name="txtPaid" /></td>
				</tr>				
				<tr> 
					<td>
						<br />
						<input type="submit" name="btnAdd" value="Confirm Payment" />
