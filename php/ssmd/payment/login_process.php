...
$sqlQuery = "SELECT * FROM authorization WHERE username = '$username' AND password = '$password' AND class = 3 ";
...
AUTO;
	...
	{
			session_start();
			$_SESSION['payment_username'] = $worked['username'];
			$_SESSION['payment_id'] = $worked['id'];
