...
$sqlQuery = "SELECT * FROM authorization WHERE username = '$username' AND password = '$password' AND class = 4 ";
...
AUTO;
	...
	{
			session_start();
			$_SESSION['research_username'] = $worked['username'];
			$_SESSION['research_id'] = $worked['id'];
