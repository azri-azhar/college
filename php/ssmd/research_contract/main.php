    ...
    <td height="251" bgcolor="#DDE6EE"><table width="100%"  border="0" cellspacing="2" cellpadding="2">
      <tr>
        ...
        <td width="77%" valign="top" bgcolor="#FFFFFF"><table width="100%"  border="0" cellspacing="2" cellpadding="2">
          <tr>
              <td bgcolor="#EEEEDD"><strong>Research Contract </strong></td>
          </tr>
          </table>          
          <p>Manage ordering information . </p>
          <p><img src="../button.gif" width="12" height="12"> <a href="add_research.php">Add or Delete Research Record</a> </p>
          <p><img src="../button.gif" width="12" height="12"> <a href="edit_research.php">Edit Research Record</a></p>
          <p><img src="../button.gif" width="12" height="12"> <a href="view_research.php">View Current Research</a><br>
            </p>
          </td></tr>
    </table></td>
  </tr>
