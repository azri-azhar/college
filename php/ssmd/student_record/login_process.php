...
$sqlQuery = "SELECT * FROM authorization WHERE username = '$username' AND password = '$password' AND class = 6 ";
...
AUTO;
	...
	{
			session_start();
			$_SESSION['record_username'] = $worked['username'];
			$_SESSION['record_id'] = $worked['id'];
