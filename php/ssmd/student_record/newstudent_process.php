...
<p>The student information has been added. Go back to <a href="main.php">main menu</a></p>
          <p>&nbsp;</p></td></tr>
    </table></td>
  </tr>
</table>
...
PAGE;
	...
	$sqlQuery = "INSERT INTO student(name, ic, gender, race, age, address, phone, email, course) 
	VALUES('$name', '$ic', '$gender', '$race', '$age', '$address', '$phone', '$email', '$course') ";
