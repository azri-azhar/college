...
$sqlQuery = "SELECT * FROM authorization WHERE username = '$username' AND password = '$password' AND class = 7 ";
...
AUTO;
	...
	{
			session_start();
			$_SESSION['system_admin'] = $worked['username'];
			$_SESSION['admin_id'] = $worked['id'];
