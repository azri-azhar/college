...
$sqlQuery = "SELECT * FROM authorization WHERE username = '$username' AND password = '$password' AND class = 2 ";
...
AUTO;
	...
	{
			session_start();
			$_SESSION['ordering_username'] = $worked['username'];
			$_SESSION['ordering_id'] = $worked['id'];
