...
<html>
    <head>
        ...
        <title>eStore -Browse Product By Category</title>
    </head>
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="77%" valign="baseline" bgcolor="#FFFFFF"><p><br>      
      &nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif"><strong>&nbsp;Browse Product By Category</strong></font></p>
      <table width="100%" border="1" cellpadding="10">
        <thead>
          <tr>
            <th><div align="center"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Category</font></strong></div></th>
          </tr>
        </thead>
        <c:forEach var="item" items="${requestScope.category}">
        <tbody>
          <tr>
            <td><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="/eStore-Web/ViewCategory/ViewProductByCategory?categoryid=${item[0]}">${item[1]}</a></font></strong></td>
          </tr>
        </tbody>
        </c:forEach>
      </table>      <p>&nbsp;</p></td>
