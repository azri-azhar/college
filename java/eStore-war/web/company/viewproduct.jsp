...
<html>
    <head>
        ...
        <title>eStore - View, Edit and Delete Product</title>
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="76%" valign="baseline" bgcolor="#FFFFFF"><br>      
      &nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif"><strong>&nbsp;View, Edit and Delete Product</strong></font><br>
      <br>
  ...
  <td><div align="center"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Product Name</font></strong></div></td>
      ...
      <td><div align="center"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Edit</font></strong></div></td>
    ...
    <tr>
      ...
      <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">${item[6]}</font></td>
      <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">RM ${item[2]}</font></td>
      <td><div align="center"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="/eStore-Web/ViewProductDetailsCompany?productid=${item[0]}">View Product Details</a></font></strong></div></td>
      <td><div align="center"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="/eStore-Web/UpdateProduct/EditForm?productid=${item[0]}">Edit Product</a></font></strong></div></td>
      <td><div align="center"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="/eStore-Web/UpdateProduct/Remove?productid=${item[0]}" onClick="return confirmSubmit()">Delete Product</a></font></strong></div></td>
    </tr>
  </c:forEach>
        </table></td>
  </tr>
