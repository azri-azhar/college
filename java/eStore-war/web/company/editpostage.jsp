...
<html>
    <head>
        ...
        <title>eStore - Edit Postage Rate and Location</title>
		<script type="text/javascript">
			function validateForm(form) {
				if (form.elements.location.value == "") {					
					alert("Please enter the location");
					return false;			
				} else if (isNaN(form.elements.rate.value)) {
					alert("Invalid postage rate. Only numbers are allowed");
					return false;
				} else if (form.elements.rate.value == "") {					
					alert("Please enter the postage rate");
					return false;
				}
				return true;
			}
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="76%" valign="baseline" bgcolor="#FFFFFF"><br>      
      &nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif"><strong>&nbsp;Edit Postage Rate and Location</strong></font><br>
      <br>
      <form onsubmit="return validateForm(this)" action="/eStore-Web/UpdatePostage/Edit" method="POST">
        <table border="0" cellpadding="10">
          <tr>
            <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Location</strong></font></td>
            <td><input type="text" name="location" value="${requestScope.location}" /></td>
          </tr>
          <tr>
            <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Rate</strong></font></td>
            <td>
              <input type="text" name="rate" value="${requestScope.rate}" />
              <input type="hidden" name="postageid" value="${requestScope.postageid}" />
            </td>
          </tr>
          <tr>
            <td><br>
