...
<html>
    <head>
        ...
        <title>eStore - Add New Postage Rate</title>
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="76%" valign="baseline" bgcolor="#FFFFFF"><br>      
      &nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif"><strong>&nbsp;Add New Postage Rate </strong></font><br>
      <br>
      <form onsubmit="return validateForm(this)" action="/eStore-Web/AddPostageRate" method="POST">
        <table border="0" cellpadding="10">
          ...
          <tr>
            <td><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Shipping rate per 1g (RM):</font></strong></td>
