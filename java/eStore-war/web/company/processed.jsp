...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <p><font size="2"> 
      <font size="2"><font face="Verdana, Arial, Helvetica, sans-serif"><img src="/eStore-Web/company/images/button.gif" width="13" height="10"></font></font><a href="javascript: history.go(-1)"><font face="Verdana, Arial, Helvetica, sans-serif">Back to previous page</font></a></font></p>
    </td>
    <td width="77%" valign="baseline" bgcolor="#FFFFFF"><p><br>      
      &nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif"><strong>&nbsp;${requestScope.forwardedHeader}</strong></font></p>
      &nbsp; 
